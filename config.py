...
def get_arguments():
    ...
    # various path
    parser.add_argument('--checkpoint_root', type=str, default='./cleanweight/erasing_net/teacher_model', help='models weight are saved here')
    ...
    parser.add_argument('--t_model', type=str, default='./weight/t_net/WRN-16-1.tar', help='path of teacher model')
    ...
    parser.add_argument('--beta1', type=int, default=1, help='beta of low layer')
    parser.add_argument('--beta2', type=int, default=1, help='beta of middle layer')
    parser.add_argument('--beta3', type=int, default=1, help='beta of high layer')
    ...
    parser.add_argument('--w_irg_vert', type=float, default=1, help='weight of Node')
    parser.add_argument('--w_irg_edge', type=float, default=1, help='weight of Edge')
    parser.add_argument('--w_irg_tran', type=float, default=1, help='weight of Graph')
    ...
    # backdoor attacks
    parser.add_argument('--inject_portion', type=float, default=0.2, help='ratio of backdoor samples')
    parser.add_argument('--target_label', type=int, default=0, help='class of target label')
    parser.add_argument('--trigger_type', type=str, default='gridTrigger', help='type of backdoor trigger')
    parser.add_argument('--target_type', type=str, default='cleanLabel', help='type of backdoor label')
    # parser.add_argument('--trigger_type', type=str, default='gridTrigger', help='type of backdoor trigger')
